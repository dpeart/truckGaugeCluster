...
void create_screen_main() {
    ...
    lv_obj_set_style_bg_color(obj, lv_color_hex(0xff000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_img_set_src(obj, &img_trans_temp);
        ...
        }
        {
            ...
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_img_set_src(obj, &img_fuel_pressure);
            lv_img_set_zoom(obj, 125);
        }
        {
            // Trans Temp
            lv_obj_t *obj = lv_meter_create(parent_obj);
            objects.trans_temp = obj;
            lv_obj_set_pos(obj, 0, 0);
            lv_obj_set_size(obj, 360, 360);
            {
                lv_meter_scale_t *scale = lv_meter_add_scale(obj);
                state->scale = scale;
                lv_meter_set_scale_ticks(obj, scale, 181, 0, 5, lv_color_hex(0xffffffff));
                lv_meter_set_scale_major_ticks(obj, scale, 30, 3, 10, lv_color_hex(0xffffffff), 25);
                lv_meter_set_scale_range(obj, scale, 80, 260, 90, 140);
                {
