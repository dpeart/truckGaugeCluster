...
void create_screen_main() {
    ...
    lv_obj_set_style_bg_color(obj, lv_color_hex(0xff000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_set_pos(obj, 60, 159);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_img_set_src(obj, &img_iat);
        ...
        {
            lv_obj_t *obj = lv_img_create(parent_obj);
            lv_obj_set_pos(obj, 143, 295);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_img_set_src(obj, &img_battery_voltage);
            lv_img_set_zoom(obj, 135);
        }
        {
            lv_obj_t *obj = lv_img_create(parent_obj);
            lv_obj_set_pos(obj, 237, 157);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_img_set_src(obj, &img_egt);
            lv_img_set_zoom(obj, 150);
        }
        {
            // IAT
            ...
            lv_obj_set_size(obj, 360, 360);
            {
                ...
                lv_meter_set_scale_major_ticks(obj, scale, 30, 3, 10, lv_color_hex(0xffffffff), 25);
                lv_meter_set_scale_range(obj, scale, 50, 200, 90, 140);
                {
        ...
        }
        {
            ...
            lv_obj_set_size(obj, 360, 360);
            {
                ...
                lv_meter_set_scale_major_ticks(obj, scale, 25, 3, 10, lv_color_hex(0xffffffff), 30);
                lv_meter_set_scale_range(obj, scale, 1500, 100, 90, 310);
                {
                    lv_meter_indicator_t *indicator = lv_meter_add_arc(obj, scale, 3, lv_color_hex(0xffffffff), 0);
                    state->indicator1 = indicator;
                    lv_meter_set_indicator_start_value(obj, indicator, 1500);
