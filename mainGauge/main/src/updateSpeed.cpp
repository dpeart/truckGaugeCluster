...
{
    uint32_t mileage_tenths = pkt.odometerTenths;

    ESP_LOGI(TAG, "[ODOMETER] Current mileage: %d.%d miles", mileage_tenths / 10, mileage_tenths % 10);
...
void update_tach_ui(int32_t target_rpm)
{
    ...
    // Faster response in simulation, smoother in real mode
    float alpha = 0.15f;
