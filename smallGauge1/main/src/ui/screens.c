...
void create_screen_main() {
    ...
    lv_obj_set_style_bg_color(obj, lv_color_hex(0xff000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        ...
        {
            lv_obj_t *obj = lv_img_create(parent_obj);
            lv_obj_set_pos(obj, 148, 278);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_img_set_src(obj, &img_fuel_location);
            lv_img_set_zoom(obj, 135);
        }
        {
            lv_obj_t *obj = lv_img_create(parent_obj);
            lv_obj_set_pos(obj, 53, 135);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_img_set_src(obj, &img_engine_temp);
            lv_img_set_zoom(obj, 150);
        }
        {
            lv_obj_t *obj = lv_label_create(parent_obj);
            objects.obj0 = obj;
            lv_obj_set_pos(obj, 266, 182);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_obj_set_style_text_color(obj, lv_color_hex(0xffffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_text_font(obj, &ui_font_robot_mono_20, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_label_set_text(obj, "PSI");
        }
        {
            lv_obj_t *obj = lv_label_create(parent_obj);
            objects.obj1 = obj;
            lv_obj_set_pos(obj, 76, 189);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_obj_set_style_text_color(obj, lv_color_hex(0xffffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_text_font(obj, &ui_font_robot_mono_20, LV_PART_MAIN | LV_STATE_DEFAULT);
        ...
        }
        {
            ...
            lv_obj_set_size(obj, 360, 360);
            {
                ...
                state->scale1 = scale;
                lv_meter_set_scale_ticks(obj, scale, 101, 0, 5, lv_color_hex(0xffffffff));
                lv_meter_set_scale_major_ticks(obj, scale, 25, 3, 10, lv_color_hex(0xffffffff), 20);
                lv_meter_set_scale_range(obj, scale, 90, 0, 90, 310);
                {
                    lv_meter_indicator_t *indicator = lv_meter_add_arc(obj, scale, 3, lv_color_hex(0xffffffff), 0);
                    state->indicator1 = indicator;
                    lv_meter_set_indicator_start_value(obj, indicator, 90);
        ...
        }
        {
            ...
            lv_obj_set_style_arc_color(obj, lv_color_hex(0xffff7a00), LV_PART_INDICATOR | LV_STATE_DEFAULT);
